...
\`\`\``
    ...
    files.map(file => {
        ...
        if (stats.isDirectory()) {
            ...
            console.log('subDirectoryFiles', subDirectoryFiles);
            if (subDirectoryFiles.length > 0)
                subDirectoryFiles.map(subDirectoryFile => {
                    console.log('subDirectoryFile', subDirectoryFile);
                    ...
                    if (subDirectoryPathStats.isDirectory()) {
                        console.log('fir-subDirectoryFile', subDirectoryFile);
                    ...
                    } else console.log('file-subDirectoryFile', subDirectoryFile);
                })
        } else {
